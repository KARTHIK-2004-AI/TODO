...
[
  {
    ...
    "message": "Jane Doe created task \"Design Mockup\" in team \"Engineering\"",
    "type": "TODO_CREATED",
    "isRead": false,
...
### GET /api/activity
Retrieves the paginated activity timeline for the authenticated user. Includes the user's personal activities and all activity logs generated by teams the user belongs to.

**Query Parameters**
- `page` (number, optional, default: 1): Target page.
- `limit` (number, optional, default: 10): Items per page.
- `type` (string, optional): Filter by entity types (`Todo`, `Team`, `Invite`, `Role`, `Account`).
...
Retrieves the paginated activity timeline for a specific team. Requester must be a member of the team.
